...
KERAS_MODEL_PATH = r'C:\ANYFITCOACH\SquatsModelTest\Squats_Model\best_model.keras'
SCALER_JSON_PATH = r'C:\ANYFITCOACH\SquatsModelTest\Squats_Model\scaler_params.json'
...
COLORS = {
    'Perfect Squats'  : (50,  205, 50),    # green
    'Legs too Narrow' : (0,   165, 255),   # orange
    'Legs too wide'   : (180, 0,   180),   # purple
    'Not a Squat'     : (0,   215, 255),   # yellow
    'Positioning...'  : (150, 150, 150),   # grey
    'No pose'         : (80,  80,  80),
}
